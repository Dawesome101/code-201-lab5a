...
function multiply(a, b) { //eslint-disable-line
  let prod = a * b;
  let str = 'The product of ' + a + ' and ' + b + ' is ' + prod + '.';
  return [prod, str];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let str1 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum1 + '.';
  let str2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prod1 + '.';
  return [sum1, prod1, str1, str2];
}
...
function sumArray(sumArr) { //eslint-disable-line
  let sum1 = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
  let str1 = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum1 + ' is their sum.';
  return [sum1, str1];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let str1 = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + prod1 + '.';
  return [prod1, str1];
}
